...
public final class FragmentDemoBinding implements ViewBinding {
  ...
  private FragmentDemoBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonRetry,
      @NonNull ImageView imageView3, @NonNull TextView textView5, @NonNull TextView textView6,
  ...
  public static FragmentDemoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDemoBinding((ConstraintLayout) rootView, buttonRetry, imageView3,
