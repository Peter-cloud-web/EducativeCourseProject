...
public final class FragmentReviewsBinding implements ViewBinding {
  ...
  private FragmentReviewsBinding(@NonNull ConstraintLayout rootView, @NonNull ProgressBar progress,
      @NonNull RecyclerView recyclerviewReviews) {
  ...
  public static FragmentReviewsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentReviewsBinding((ConstraintLayout) rootView, progress, recyclerviewReviews);
    }
