...
public final class FragmentFavouriteMovieBinding implements ViewBinding {
  ...
  private FragmentFavouriteMovieBinding(@NonNull FrameLayout rootView,
  ...
  @NonNull
  public static FragmentFavouriteMovieBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentFavouriteMovieBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_favourite_movie, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentFavouriteMovieBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFavouriteMovieBinding((FrameLayout) rootView, favRecyclerView);
    }
