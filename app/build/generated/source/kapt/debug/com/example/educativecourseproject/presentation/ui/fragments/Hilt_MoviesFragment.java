 ...
 */
public abstract class Hilt_MoviesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MoviesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MoviesFragment_GeneratedInjector) this.generatedComponent()).injectMoviesFragment(UnsafeCasts.<MoviesFragment>unsafeCast(this));
    }
  }
