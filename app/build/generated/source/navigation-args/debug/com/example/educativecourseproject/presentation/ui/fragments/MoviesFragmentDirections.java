...
public class MoviesFragmentDirections {
  ...
  @NonNull
  public static ActionMoviesFragmentToMovieDetailsFragment actionMoviesFragmentToMovieDetailsFragment(
      @NonNull String image, @NonNull String backdrop, @NonNull String title,
      @NonNull String description, float rating, int id) {
    return new ActionMoviesFragmentToMovieDetailsFragment(image, backdrop, title, description, rating, id);
  }

  public static class ActionMoviesFragmentToMovieDetailsFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionMoviesFragmentToMovieDetailsFragment(@NonNull String image,
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMoviesFragmentToMovieDetailsFragment setImage(@NonNull String image) {
      if (image == null) {
        throw new IllegalArgumentException("Argument \"image\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("image", image);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMoviesFragmentToMovieDetailsFragment setBackdrop(@NonNull String backdrop) {
      if (backdrop == null) {
        throw new IllegalArgumentException("Argument \"backdrop\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("backdrop", backdrop);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMoviesFragmentToMovieDetailsFragment setTitle(@NonNull String title) {
      if (title == null) {
        throw new IllegalArgumentException("Argument \"title\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("title", title);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMoviesFragmentToMovieDetailsFragment setDescription(@NonNull String description) {
      if (description == null) {
        throw new IllegalArgumentException("Argument \"description\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("description", description);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMoviesFragmentToMovieDetailsFragment setRating(float rating) {
      this.arguments.put("rating", rating);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMoviesFragmentToMovieDetailsFragment setId(int id) {
      this.arguments.put("id", id);
      return this;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionMoviesFragmentToMovieDetailsFragment that = (ActionMoviesFragmentToMovieDetailsFragment) object;
    ...
    public String toString() {
      return "ActionMoviesFragmentToMovieDetailsFragment(actionId=" + getActionId() + "){"
          + "image=" + getImage()
