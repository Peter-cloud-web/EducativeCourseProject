...
public class SearchMovieFragmentDirections {
  ...
  @NonNull
  public static ActionSearchMovieFragment2ToMovieDetailsFragment actionSearchMovieFragment2ToMovieDetailsFragment(
      @NonNull String image, @NonNull String backdrop, @NonNull String title,
      @NonNull String description, float rating, int id) {
    return new ActionSearchMovieFragment2ToMovieDetailsFragment(image, backdrop, title, description, rating, id);
  }

  public static class ActionSearchMovieFragment2ToMovieDetailsFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionSearchMovieFragment2ToMovieDetailsFragment(@NonNull String image,
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionSearchMovieFragment2ToMovieDetailsFragment setImage(@NonNull String image) {
      if (image == null) {
        throw new IllegalArgumentException("Argument \"image\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("image", image);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionSearchMovieFragment2ToMovieDetailsFragment setBackdrop(@NonNull String backdrop) {
      if (backdrop == null) {
        throw new IllegalArgumentException("Argument \"backdrop\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("backdrop", backdrop);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionSearchMovieFragment2ToMovieDetailsFragment setTitle(@NonNull String title) {
      if (title == null) {
        throw new IllegalArgumentException("Argument \"title\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("title", title);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionSearchMovieFragment2ToMovieDetailsFragment setDescription(
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionSearchMovieFragment2ToMovieDetailsFragment setRating(float rating) {
      this.arguments.put("rating", rating);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionSearchMovieFragment2ToMovieDetailsFragment setId(int id) {
      this.arguments.put("id", id);
      return this;
    }
    ...
    public int getActionId() {
      return R.id.action_searchMovieFragment2_to_movieDetailsFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionSearchMovieFragment2ToMovieDetailsFragment that = (ActionSearchMovieFragment2ToMovieDetailsFragment) object;
    ...
    public String toString() {
      return "ActionSearchMovieFragment2ToMovieDetailsFragment(actionId=" + getActionId() + "){"
          + "image=" + getImage()
